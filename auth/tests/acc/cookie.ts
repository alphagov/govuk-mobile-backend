...
const cookie_attributes = ["domain", "path", "expires", "maxage", "secure", "httponly", "samesite"];
...
export class CookieJar {
     ...
     */
    private pathMatches(cookiePath: string | undefined, urlPath: string): boolean {
     ...
     */
    private generateCookieKey(name: string, domain: string | undefined, path: string | undefined): string {
	...
	for (const header of setCookieHeaders) {
	    ...
	    const key = this.generateCookieKey(cookie.name, cookie.domain, cookie.path);
