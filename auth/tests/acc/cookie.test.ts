...
describe("Cookie helper tests", () => {
	...
	expect(parsed_cookie.get("csrf-state")).to.equal("u0nqoYovBK5OQbNqe9ZSlC3MRVgSKUddzNfgrtlG9wJeZt3lpOuei9KJKGOX8sTH8MUCNNvX308ChZHVJnOiretXVKgWOPD026zA0qdyKASn0Wh58dJjNW0WgPPg3IvA2UuDqLAYIPHTMXSDkeJ423kxDPtyZRvyxqgan9Bhq7Y");
