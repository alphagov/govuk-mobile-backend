...
describe("Set up CloudWatch Alarm for Cognito SignInThrottles with supporting alarm resources", () => {
  ...
  const snsTopicUnderTest = snsTopicResources[
    "CloudWatchAlarmSignInThrottlesTopicPagerDuty"
  ] as any;
  ...
  it("should create a CloudWatch alarm for SignInThrottles", () => {
  ...
  it("should create a SNS topic for SignInThrottles", () => {
  ...
  it("should create a SNS subscription for SignInThrottles", () => {
    ...
    expect(subscriptionUnderTest.Properties.Endpoint).toEqual({
      "Fn::If": [
        ...
        {
          "Fn::Sub": "{{resolve:ssm:/pager-duty/url}}",
        },
      ],
    });
  ...
  it("should create an SNS topic policy for SignInThrottles", () => {
