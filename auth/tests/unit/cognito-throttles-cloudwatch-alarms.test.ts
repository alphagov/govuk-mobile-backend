...
const testCases: AlarmTestCase[] = [
  {
    ...
    alarmDescription: "Alarm when federated requests exceeds 5 per minute. \nSee resolution steps in runbook: \nhttps://gov-uk.atlassian.net/wiki/spaces/GOVUK/pages/4539416577/Runbook+Cognito+Alarms#Runbook-Step%3A-CognitoFederationThrottle\n",
  ...
  },
  {
    ...
    alarmDescription: "Alarm when the sign in rate exceeds 5 per minute. \nSee resolution steps in runbook: \nhttps://gov-uk.atlassian.net/wiki/spaces/GOVUK/pages/4539416577/Runbook+Cognito+Alarms#Runbook-Step%3A-CognitoSignInThrottle\n",
    topicDisplayName: "cloudwatch-alarm-topic",
    statistic: "Sum",
    period: 60,
    evaluationPeriods: 5,
  ...
  },
  {
    ...
    alarmDescription: "Alarm when the sign up rate exceeds 5 per minute. \nSee resolution steps in runbook: \nhttps://gov-uk.atlassian.net/wiki/spaces/GOVUK/pages/4539416577/Runbook+Cognito+Alarms#Runbook-Step%3A-CognitoSignUpThrottle\n",
    topicDisplayName: "cloudwatch-alarm-topic",
    statistic: "Sum",
    period: 60,
    evaluationPeriods: 5,
  ...
  },
  {
    ...
    alarmDescription: "Alarm when the token refresh rate exceeds 5 per minute. \nSee resolution steps in runbook: \nhttps://gov-uk.atlassian.net/wiki/spaces/GOVUK/pages/4539416577/Runbook+Cognito+Alarms#Runbook-Step%3A-CognitoTokenRefreshThrottle\n",
    topicDisplayName: "cloudwatch-alarm-topic",
    statistic: "Sum",
    period: 60,
    evaluationPeriods: 5,
  ...
  },
  {
    ...
    topicResource: "CloudWatchAlarmTopicPagerDuty",
    alarmDescription: "Alarm when the WAF error rate exceeds 5 per minute. \nSee resolution steps in runbook: \nhttps://gov-uk.atlassian.net/wiki/spaces/GOVUK/pages/4529389569/Runbook+WAF+-+High+number+WAF+throttling\n",
