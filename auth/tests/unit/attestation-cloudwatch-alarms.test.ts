...
const testCases: AlarmTestCase[] = [
  {
    ...
    metricName: "4XXError",
    alarmDescription: "Alarm detects a high rate of client-side errors. \nSee resolution steps in runbook: \nhttps://gov-uk.atlassian.net/wiki/spaces/GOVUK/pages/4544724994/Runbook+Attestation+API+Gateway+alarms#Runbook%3A-API-Gateway-4xx-Error-Alarm\n",
  ...
  },
  {
    ...
    slackChannelConfigurationResource: "SlackSupportChannelConfiguration",
    metricName: "5XXError",
    alarmDescription: "Alarm detects a high rate of server-side errors. \nSee resolution steps in runbook: \nhttps://gov-uk.atlassian.net/wiki/spaces/GOVUK/pages/4544724994/Runbook+Attestation+API+Gateway+alarms#Runbook%3A-API-Gateway-5xx-Error-Alarm\n",
    topicDisplayName: "cloudwatch-alarm-topic",
    statistic: "Average",
    period: 60,
    evaluationPeriods: 3,
  ...
  },
  {
    ...
    slackChannelConfigurationResource: "SlackSupportChannelConfiguration",
    metricName: "Latency",
    alarmDescription: "Alarm detects a high rate of latency errors. \nSee resolution steps in runbook: \nhttps://gov-uk.atlassian.net/wiki/spaces/GOVUK/pages/4544724994/Runbook+Attestation+API+Gateway+alarms#Runbook%3A-API-Gateway-Latency-Alarm\n",
    topicDisplayName: "cloudwatch-alarm-topic",
  ...
  },
  {
    ...
    alarmDescription: "Alarm when the Auth Proxy WAF rate limit exceeds 300 requests per 5 minutes. \nSee resolution steps in runbook: \nhttps://gov-uk.atlassian.net/wiki/spaces/GOVUK/pages/4531716123/Runbook+Attestation+WAF+throttling#Runbook-Step%3A-AuthWAFRateLimitingAlarm\n",
    topicDisplayName: "cloudwatch-alarm-topic",
    statistic: "Sum",
