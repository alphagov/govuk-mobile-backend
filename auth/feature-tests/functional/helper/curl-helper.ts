...
export class CurlHelper {
    ...
    async post(endpoint: string, data: any, headers: Record<string, string> = {}): Promise<AxiosResponse> {
        const config: AxiosRequestConfig = {
            method: 'POST',
            url: `${this.baseUrl}${endpoint}`,
            data,
    ...
    async put(endpoint: string, data: any, headers: Record<string, string> = {}): Promise<AxiosResponse> {
        const config: AxiosRequestConfig = {
            method: 'PUT',
            url: `${this.baseUrl}${endpoint}`,
            data,
