 ...
 */
const validateCognitoUrl = async (configName: string, cognitoUrl: string): Promise<URL> => {
...
export async function getConfig(): Promise<AppConfig> {
    ...
    const sanitizedUrl = await validateCognitoUrl(customDomainConfigName, cognitoUrl);
