...
class ApiGatewayStageThrottlingCheck(BaseResourceCheck):
    def __init__(self):
        name = "Ensure every API Gateway Stage MethodSettings entry has ThrottlingRateLimit and ThrottlingBurstLimit"
        id = "CKV2_GOVUKAPP_3"
...
check = ApiGatewayStageThrottlingCheck()
