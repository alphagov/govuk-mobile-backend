...
const testCases: AlarmTestCase[] = [
  {
    name: 'SharedSignalThrottles',
    alarmName: 'shared-signal-waf-throttling-alarm',
    actionsEnabled: true,
    alarmResource: 'SharedSignalWafThrottlingAlarm',
    ...
    dimensions: [
      {
        Name: 'WebACL',
        Value: { 'Fn::Sub': '${AWS::StackName}-shared-signal-waf' },
      },
      {
        Name: 'Rule',
        Value: {
