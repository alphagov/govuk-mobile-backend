...
const feature = await loadFeature('feature-tests/vitest-features/GovUKMobileCognitoWAFAssociation.feature')
...
describeFeature(feature, ({ BeforeAllScenarios, Scenario }) => {
    ...
    Scenario(`A template can associate the GOV UK Cognito Userpool with a WAF`, ({ Given, Then }) => {
